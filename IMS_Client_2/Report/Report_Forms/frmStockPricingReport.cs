...
namespace IMS_Client_2.Report.Report_Forms
{
    public partial class frmStockPricingReport : Form
    {
        ...
        private void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            if (dsStockPricing!=null && dsStockPricing.Tables.Count>0)
            {
                if (dsStockPricing.Tables[0].Rows.Count>0)
                {
                    ...
                    ReportDataSource rds = new ReportDataSource("dsStockPricingReport", dsStockPricing.Tables[0]);
